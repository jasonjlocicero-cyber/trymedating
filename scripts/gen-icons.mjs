...
// Favicons + Windows .ico
const fav32Path = path.join(root, "public", "favicon-32.png");
const fav16Path = path.join(root, "public", "favicon-16.png");
await sharp(base1024).resize(32, 32).png().toFile(fav32Path);
await sharp(base1024).resize(16, 16).png().toFile(fav16Path);
